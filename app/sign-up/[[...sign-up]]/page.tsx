...
export default function SignUpPage() {
  return (
    <div className="lg:grid lg:grid-cols-2 flex w-full h-screen lg:flex-row min-h-screen  justify-center items-center">
      ...
      <div className="hidden lg:flex  h-full relative justify-center items-center bg-gray-900">
        <div className="text-center p-8">
          ...
          <p className="text-white text-lg mt-4">Create your account to get started</p>
        </div>
      </div>
      ...
      <div className=" flex items-center justify-center  bg-white p-8 lg:p-16  ">
        <div className=" ">
          ...
          <h1 className="text-3xl font-semibold text-center text-gray-800 mb-8">Create an Account</h1>
          <SignUp
            path="/sign-up"
            routing="path"
            signInUrl="/sign-in" // Add sign-in URL if needed
          />
        </div>
      </div>
    </div>
